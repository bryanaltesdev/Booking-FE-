...
function Create(props) {
  ...
  const createNewCalendar = () => {
    console.log(name, startDate, startTime, endTime, endDate, minimum, maximum, monday, tuesday, wednesday, thursday, friday, saturday, sunday)
    const data = {
      name: name,
      startDate: startDate,
      endDate: endDate,
  ...
  return (
    <div>
      {
        location.pathname === '/Place/Create' ?
          <form>
              ...
              <div className="px-4 py-5 bg-white sm:p-6">
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6 sm:col-span-2 lg:col-span-2">
                    ...
                    {/* <input type="text" name="city" id="city" onChange={(e) => { setStartTime(e.target.value) }} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" /> */}
                    <TimePicker
                  ...
                  <div className="col-span-6 sm:col-span-2 lg:col-span-2">
                    ...
                    <TimePicker
                      ...
                      value={endTime}
                    />
                    {/* <input type="text" name="state" id="state" onChange={(e) => { setEndTime(e.target.value) }} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" /> */}
                  </div>
